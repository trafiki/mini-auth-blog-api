...
// ARTICLES
export const createArticle = 'INSERT INTO articles (author_id, title, article) values ($1, $2, $3, $4) returning *';
export const findAnArticle = 'SELECT * FROM articles WHERE article_id = $1';
export const modifyArticle = 'UPDATE articles SET title = $1 , article = $2, category = $3 WHERE article_id = $4 and author_id = $5 RETURNING *';
